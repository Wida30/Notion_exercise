...
const peli2010 = movies.find((movie) =>{
        if (movie.date === 2010) {
            return movie.title;            
        }
    }
...
const nameAlien = aliens.find((alien) => alien.name === "Cucushumushu");

const nameMutation = mutations.find((mutaion) => mutaion.name === "Porompompero" );

const alienMutation = {...nameAlien, mutacion : {...nameMutation}};
